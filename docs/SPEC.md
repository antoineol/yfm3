...
- NTSC Ghost Drop More Cards x50/x150/x1000 keeps the selected reward/save count, but leaves the original result-screen UI hook untouched and caps only the injected display-card script loop at x15.
