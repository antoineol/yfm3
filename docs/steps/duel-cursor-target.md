...
- Map PAL-specific cursor target and field focus addresses before treating focused-card display as supported on PAL.
...
- PAL cannot reuse the NTSC relative offsets. The PAL profile has already proven that nearby duel variables move independently.
