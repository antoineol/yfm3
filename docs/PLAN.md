...
| **Campaign Reward Pool Evidence** (DONE) | [`docs/dropx15.md`](dropx15.md) | Capture rank counters and credited-card fit evidence; use the community Ghost/FMR x15 routine for compatible NTSC/Gold images, expose selectable PAL French card and starchip reward multipliers through the verified scratch relocation plus root save-update helper, and execute-test the PAL helper arithmetic including PS1 load-delay behavior |
