...
| P5: New Card Deck Swap Suggestion | [`docs/steps/p6-new-card-suggest-to-deck.md`](steps/p6-new-card-suggest-to-deck.md) | Suggest and optionally apply the best one-card deck upgrade after adding a card |
