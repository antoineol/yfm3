...
| **Campaign Reward Pool Evidence** (CURRENT) | — | Capture rank counters, reward selector evidence, inferred credited-card fit, and upgrade the local x15 patch so hidden rewards reuse the visible rank-pool selector |
