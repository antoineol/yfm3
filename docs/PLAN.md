...
| P5: New Card Deck Swap Suggestion (DONE) | [`docs/steps/p6-new-card-suggest-to-deck.md`](steps/p6-new-card-suggest-to-deck.md) | Suggest and optionally apply a ranked-then-exact one-card deck upgrade after adding a card |
| P5.5: Simplify Deck Swap Suggestion (DONE) | [`docs/steps/p6.5-refactor.md`](steps/p6.5-refactor.md) | Re-scope the feature around the minimal useful behavior and keep the worker path sub-second |
