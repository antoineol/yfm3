...
| **Campaign Reward Pool Evidence** (DONE) | [`docs/dropx15.md`](dropx15.md) | Capture rank counters and credited-card fit evidence; use the community Ghost/FMR x15 routine for compatible NTSC/Gold images, use the verified PAL French x30 scratch relocation, and keep verified x15 starchip save updates |
| **Bridge Distribution** | — | Portable Windows zip with in-app setup guide, update notification, and GitHub Actions release workflow |
| **Bridge Restart Resilience** (DONE) | [`docs/steps/bridge-restart-resilience.md`](steps/bridge-restart-resilience.md) | Preserve the last ready app state through short bridge live-reload reconnects and retry the bridge WebSocket quickly enough that normal boot time is not amplified by the browser |
