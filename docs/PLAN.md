...
| **Post-Duel Optimization Reliability** (DONE) | — | Keep the collection-change detector app-wide, preserve baselines across transient bridge resets and missing collection frames, buffer detected rewards until deck/game data is ready, and keep the results screen in the duel lifecycle until the game scene actually exits |
