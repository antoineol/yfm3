...
| **Campaign Reward Pool Evidence** (CURRENT) | — | Capture rank counters, reward selector evidence, inferred credited-card fit, and keep unsafe x15 patch variants upgradeable back to the tested reward routine |
