...
const base =
  "h-10 min-w-[40px] lg:h-8 lg:min-w-[32px] inline-flex items-center justify-center rounded transition-colors disabled:opacity-30 disabled:cursor-not-allowed";
