...
const base =
  "h-11 min-w-[44px] lg:h-8 lg:min-w-[32px] inline-flex items-center justify-center rounded transition-colors disabled:opacity-30 disabled:cursor-not-allowed";
