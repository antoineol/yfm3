...
- PAL French `0x0eb280` is not the equip counter even though it is `fusionCounter+1`; it was observed to track the fusion counter. Do not expose full PAL rank counters until the real equip counter is mapped.
